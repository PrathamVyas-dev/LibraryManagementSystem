    ...
    public partial class first : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                table: "Members",
                columns: new[] { "MemberID", "Address", "Email", "MembershipStatus", "Name", "Phone" },
                values: new object[,]
                {
                    { 1, "Admin Address", "admin@library.com", "Active", "Admin", "1234567890" },
                    { 2, "Librarian Address", "librarian@library.com", "Active", "Librarian", "0987654321" },
                    { 3, "User Address", "user@library.com", "Active", "User", "1122334455" }
                });
