...
export class BorrowBookComponent implements OnInit {
  ...
  // Fix the onSubmit method to properly handle the form data
  onSubmit(): void {
    ...
    console.log('Submitting borrow request:', borrowDto);
  ...
  // Load all members (for admin and librarian)
  loadMembers(): void {
    ...
    this.memberService.getMembers().subscribe({
      next: (members) => {
        ...
        this.filteredMembers = members.filter(member => member.membershipStatus === 'Active');
